...
public class BlockTri extends Block
{
    private IIcon blockIcon2;

    protected BlockTri(Material material)
    {
        super(material);
    }
    ...
    {
        this.blockIcon = iiconRegister.registerIcon(Reference.MOD_ID + ":white");
        this.blockIcon2 = iiconRegister.registerIcon(Reference.MOD_ID + ":yellow");
    }
